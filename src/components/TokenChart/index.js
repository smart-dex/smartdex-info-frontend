...
const ChartWrapper = styled.div`
  ...
  .list-option {
    border: 1px solid ${({ theme }) => theme.borderoptionChart};
    border-radius: 5px;
    display: flex;
...
const PriceOption = styled(OptionButton)`
  ...
  padding: 8px 10px;
  :nth-child(2) {
    border-left: 1px solid ${({ theme }) => theme.borderoptionChart};
    border-right: 1px solid ${({ theme }) => theme.borderoptionChart};
  }
`
      ...
      {below600 ? (
        <RowBetween mb={40}>
          ...
          >
              ...
              {chartFilter === CHART_VIEW.PRICE && (
                <AutoRow gap="4px">
                  <div className="list-option">
                    <PriceOption
                      className={frequency === DATA_FREQUENCY.DAY ? 'active' : ''}
                      onClick={() => {
                    ...
                    <PriceOption
                      className={frequency === DATA_FREQUENCY.HOUR ? 'active' : ''}
                      onClick={() => setFrequency(DATA_FREQUENCY.HOUR)}
                    >
                      H
                  </PriceOption>
                    <PriceOption
                      className={frequency === DATA_FREQUENCY.LINE ? 'active' : ''}
            ...
            <AutoRow style={{ marginRight: '35px' }} justify="flex-end" gap="6px" align="flex-start">
              <OptionButton
